...
TEST_STREAM_LDFLAGS := -rpath $(LDRPATH) -L$(OUTPUT_DIR) -lbuxtehude
...
TEST_VALIDATE_LDFLAGS := -rpath $(LDRPATH) -L$(OUTPUT_DIR) -lbuxtehude
...
TEST_BUX_LDFLAGS := -rpath $(LDRPATH) -L$(OUTPUT_DIR) -lbuxtehude -lfmt
